...
# convert_mot_to_fairmot('/work/Institution/author/data/MOT15/', '/work/Institution/author/post_data/MOT15/', 'train')

# Usage for test dataset
convert_mot_to_fairmot('/work/Institution/author/data/MOT15/', '/work/Institution/author/post_data/MOT15_test', 'test')
