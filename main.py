...
def get_args_parser():
    ...
    parser.add_argument('--mot_path', default='/work/Institution/author/data/', type=str)
    ...
    parser.add_argument('--query_interaction_layer', default='ETEM', type=str,
                        help="")
...
def main(args):
    ...
    if args.resume:
        if args.resume.startswith('https'):
            ...
            logging.debug(f"Resumed Training From: {args.resume}")
